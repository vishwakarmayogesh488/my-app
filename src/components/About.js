...
{/* <button onClick={togglestyle} type='button'className="btn btn-primary">{setBtntext}</button> */}
<button  onClick={togglestyle} type="button" class="btn btn-primary">{setBtntext}</button>
</div>
    </div>
  )
  }
